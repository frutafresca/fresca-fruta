        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive" id="letra">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/frutafresca/Usuario/iniciar sesion.php">Iniciar sesión</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/frutafresca/Usuario/registro.php">Registrarse</a></li>
                </ul>
            </div>
        </div>
    </nav>
