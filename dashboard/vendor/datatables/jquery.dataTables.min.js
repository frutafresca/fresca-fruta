...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
    ...
    function Fb(a, b) { var c = a.fnFormatNumber,
            d = a._iDisplayStart + 1,
            e = a._iDisplayLength,
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            I(function(a, b) { if (h.inArray(a, Zb) !== -1) a.style.width = v[b] },
                o);
            h(L).height(0);
            s && (I(B, R), I(function(a) { z.push(a.innerHTML);
            ...
            s && I(function(a, b) { a.innerHTML = '<div class="dataTables_sizing">' + z[b] + "</div>";
                ...
                a.style.width = x[b] }, R);
            if (p.outerWidth() <
                f) { Q = j.scrollHeight > j.offsetHeight || "scroll" == m.css("overflow-y") ? f + b : f; if (V && (j.scrollHeight > j.offsetHeight || "scroll" == m.css("overflow-y"))) t.width = w(Q - b);
    ...
    function ya(a) {
        var b = a.aLastSort,
            ...
            e = a.oFeatures,
            f, g;
        if (e.bSort && e.bSortClasses) { e = 0; for (f = b.length; e < f; e++) g = b[e].src, h(C(a.aoData, "anCells", g)).removeClass(c + (2 > e ? e + 1 : 3));
    ...
    function za(a) { if (a.oFeatures.bStateSave && !a.bDestroying) { var b = { time: +new Date, start: a._iDisplayStart, length: a._iDisplayLength, order: h.extend(!0, [], a.aaSorting), search: Cb(a.oPreviousSearch), columns: h.map(a.aoColumns, function(b, d) { return { visible: b.bVisible, search: Cb(a.aoPreSearchCols[d]) } }) };
    ...
    n.util = { throttle: function(a, b) { var c = b !== k ? b : 200,
                ...
                d && g < d + c ? (clearTimeout(e), e = setTimeout(function() { d = k;
                    a.apply(b, j) }, c)) : (d = g, a.apply(b, j)) } }, escapeRegex: function(a) { return a.replace(bc, "\\$1") } };
    ...
    r = function(a, b) { if (!(this instanceof r)) return new r(a, b); var c = [],
            d = function(a) {
                (a = cc(a)) && c.push.apply(c, a) }; if (h.isArray(a))
    ...
    var Vb = function(a, b, c) { if (c) { var d = new r(a);
    ...
    var bb = function(a, b, c, d, e) { var f = [],
            ...
            i = 0; for (l = b.length; i < l; i++) { j = b[i] && b[i].split && !b[i].match(/[\[\(:]/) ? b[i].split(",") : [b[i]];
                m = 0; for (n = j.length; m < n; m++)(g = c("string" === typeof j[m] ? h.trim(j[m]) : j[m])) && g.length && (f = f.concat(g)) }
            a = v.selector[a]; if (a.length) { i = 0; for (l = a.length; i < l; i++) f = a[i](d, e, f) } return ra(f) },
        cb = function(a) {
            a || (a = {});
        ...
        Da = function(a, b) {
            ...
            if ("current" == d) { c = a._iDisplayStart; for (d = a.fnDisplayEnd(); c < d; c++) f.push(g[c]) } else if ("current" == c || "applied" == c)
                if ("none" == j) f = e.slice();
                    ...
                    f = h.map(e, function(a) { return !i.hasOwnProperty(a) ? a : null }) } } else if ("index" == c || "original" == c) { c = 0; for (d = a.aoData.length; c < d; c++) "none" == j ? f.push(c) : (e = h.inArray(c, g), (-1 === e && "removed" == j || 0 <= e && "applied" == j) && f.push(c)) }
            return f
        };
    o("rows()", function(a, b) {
    ...
    o("rows.add()",
        function(a) { var b = this.iterator("table", function(b) { var c, f, g, h = [];
                    f = 0; for (g = a.length; f < g; f++) c = a[f], c.nodeName && "TR" === c.nodeName.toUpperCase() ? h.push(oa(b, c)[0]) : h.push(O(b, c)); return h }, 1),
                c = this.rows(-1);
            c.pop();
        ...
        if (null === b || b === k) return this.iterator("table", function(b) {
            ...
            return bb("cell", d, function(a) {
                var c =
                    typeof a === "function";
                if (a === null || a === k || c) { o = [];
                    s = 0; for (r = g.length; s < r; s++) { l = g[s]; for (t = 0; t < n; t++) { w = { row: l, column: t }; if (c) { v = f[l];
    ...
    n.tables = n.fnTables = function(a) { var b = !1;
        h.isPlainObject(a) && (b = a.api, a = a.visible); var c = h.map(n.settings, function(b) { if (!a || a && h(b.nTable).is(":visible")) return b.nTable }); return b ? new r(c) : c };
    ...
    h.each(["column", "row", "cell"], function(a, b) { o(b + "s().every()", function(a) { var d = this.selector.opts,
                e = this; return this.iterator(b, function(f, g, h, i, l) { a.call(e[b](g, "cell" === b ? h : d, "cell" === b ? d : k), g, h, i, l) }) }) });
    ...
    n.render = { number: function(a, b, c, d, e) { return { display: function(f) { if ("number" !== typeof f && "string" !== typeof f) return f; var g = 0 > f ? "-" : "",
